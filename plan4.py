...
"}")
        ...
        self.horizontalLayout_5.addWidget(self.time_btn)
        self.alarm_btn = QtWidgets.QPushButton(self.horizontalLayoutWidget_3)
        self.alarm_btn.setObjectName("alarm_btn")
        self.horizontalLayout_5.addWidget(self.alarm_btn)
        self.lcdNumber = QtWidgets.QLCDNumber(Form)
        self.lcdNumber.setGeometry(QtCore.QRect(10, 70, 281, 61))
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton.setText(_translate("Form", "Аналоговые"))
