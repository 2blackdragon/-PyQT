...
# Form implementation generated from reading ui file 'plan2.ui'
#
...
"}")
        ...
        self.add_alarm_btn = QtWidgets.QPushButton(Form)
        self.add_alarm_btn.setGeometry(QtCore.QRect(10, 210, 281, 21))
        self.add_alarm_btn.setObjectName("add_alarm_btn")
        self.gridLayoutWidget = QtWidgets.QWidget(Form)
        self.gridLayoutWidget.setGeometry(QtCore.QRect(10, 40, 281, 161))
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "                      Будильник"))
        ...
        self.add_alarm_btn.setText(_translate("Form", "Добавить будильник"))
